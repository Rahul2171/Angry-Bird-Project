...
redbird = pygame.image.load(
    "D:\Angry Bird/resources/images/red-bird3.png").convert_alpha()
background2 = pygame.image.load(
    "D:\Angry Bird/resources/images/background3.png").convert_alpha()
sling_image = pygame.image.load(
    "D:\Angry Bird/resources/images/sling-3.png").convert_alpha()
full_sprite = pygame.image.load(
    "D:\Angry Bird/resources/images/full-sprite.png").convert_alpha()
rect = pygame.Rect(181, 1050, 50, 50)
cropped = full_sprite.subsurface(rect).copy()
pig_image = pygame.transform.scale(cropped, (30, 30))
buttons = pygame.image.load(
    "D:\Angry Bird/resources/images/selected-buttons.png").convert_alpha()
pig_happy = pygame.image.load(
    "D:\Angry Bird/resources/images/pig_failed.png").convert_alpha()
stars = pygame.image.load(
    "D:\Angry Bird/resources/images/stars-edited.png").convert_alpha()
...
def load_music():
    """Load the music"""
    song1 = 'D:\Angry Bird/resources/sounds/angry-birds.ogg'
